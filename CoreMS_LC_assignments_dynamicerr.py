...
def assign_formula(timestart,interval,parser,refmasslist,data_dir,file,error):
	os.chdir('/CoreMS')
	...
	MSParameters.mass_spectrum.max_picking_mz=900 # integer, maximum m/z that will be assigned
...
def run_assignment(time_min,time_max,interval,data_dir,file,refmasslist,error):
	...
	for timestart in times:
		...
		assigment=assign_formula(timestart,interval,parser,refmasslist,data_dir,file,error)
...
if __name__ == '__main__':
	...
	samplelist_file = "PTcoculture_samplelist_QC.csv"
	refmasslist = "siloxanes_extend_pos.ref"
	#refmasslist = "ie_231206_ngptfe_pooled_26_calibrants_pos.ref"
	interval = 2 # Time interval for ms spectrum averaging (in minutes)
	time_min = 0 # Minimum retention time for formula assigments (minutes)
	time_max = 22 # Maximum retention time for formula assigments (minutes)
